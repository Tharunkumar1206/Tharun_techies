const assests = {
    ...
    product1: new URL('./product.png', import.meta.url).href,
    doctor: new URL('./doctor.png', import.meta.url).href,
    heart: new URL('./heart.png', import.meta.url).href,
    teeth: new URL('./teeth.png', import.meta.url).href,
    face: new URL('./face.png', import.meta.url).href,
    sims: new URL('./sims.png', import.meta.url).href,
